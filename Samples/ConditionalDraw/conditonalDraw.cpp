...
namespace vksample {
	...
	class ConditionalDrawVKSample : public VKSample<ConditionalDraw> {
	  public:
		ConditionalDrawVKSample() : VKSample<ConditionalDraw>() {}
...
int main(int argc, const char **argv) {
	...
	std::unordered_map<const char *, bool> require
