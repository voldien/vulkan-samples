...
class Skybox : public VKWindow {
  ...
  public:
	Skybox(std::shared_ptr<VulkanCore> &core, std::shared_ptr<VKDevice> &device)
...
int main(int argc, const char **argv) {
	...
	try {
		VKSampleWindow<Skybox> skybox(argc, argv, required_device_extensions, {}, required_instance_extensions);
		skybox.run();
