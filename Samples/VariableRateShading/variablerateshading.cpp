...
namespace vksample {
	 ...
	 *
	 */
	class VariableRateShading : public VKWindow {
	  private:
	  ...
	  public:
		VariableRateShading(std::shared_ptr<VulkanCore> &core, std::shared_ptr<VKDevice> &device)
			...
			this->show();
			this->setTitle("VariableRateShading");
		}
		 ~VariableRateShading() override = default;
...
int main(int argc, const char **argv) {
	...
	try {
		VKSample<vksample::VariableRateShading> sample;
