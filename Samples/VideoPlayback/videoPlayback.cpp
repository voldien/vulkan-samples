...
namespace vksample {
	...
	class VideoPlaybackVKSample : public VKSample<AVVideoPlayback> {
	  public:
		VideoPlaybackVKSample() : VKSample<AVVideoPlayback>() {}
...
int main(int argc, const char **argv) {
	...
	try {
		vksample::VideoPlaybackVKSample videoplaybackSample;
