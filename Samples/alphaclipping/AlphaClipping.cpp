...
namespace vksample {
	 ...
	 *
	 */
	class AlphaClipping : public VKWindow {
	  private:
	...
	class AlphaClippingVKSample : public VKSample<AlphaClipping> {
	  public:
		AlphaClippingVKSample() : VKSample<AlphaClipping>() {}
...
int main(int argc, const char **argv) {
	...
	try {
		vksample::AlphaClippingVKSample sample;
