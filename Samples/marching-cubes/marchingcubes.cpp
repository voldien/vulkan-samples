...
class MarchingCubes : public VKWindow {
  private:
  ...
  public:
	MarchingCubes(std::shared_ptr<VulkanCore> &core, std::shared_ptr<VKDevice> &device)
...
int main(int argc, const char **argv) {
	...
	try {
		VKSampleWindow<MarchingCubes> marchingcubes(argc, argv, required_device_extensions, {},
