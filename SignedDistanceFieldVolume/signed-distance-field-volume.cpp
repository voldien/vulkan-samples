...
class SignedDistanceFieldVolumemWindow : public VKWindow {
  private:
	VkPipeline particleSim;
	VkPipeline particleGraphicPipeline;

  public:
	SignedDistanceFieldVolumemWindow(std::shared_ptr<VulkanCore> &core, std::shared_ptr<VKDevice> &device)
...
int main(int argc, const char **argv) {
	...
	try {
		...
		SignedDistanceFieldVolumemWindow window(core, d);
