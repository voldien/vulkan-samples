...
class SilhouetteDetectionWindow : public VKWindow {
  private:
  ...
  public:
	SilhouetteDetectionWindow(std::shared_ptr<VulkanCore> &core, std::shared_ptr<VKDevice> &device)
		: VKWindow(core, device, -1, -1, -1, -1) {
		prevTimeCounter = SDL_GetPerformanceCounter();
	}
	~SilhouetteDetectionWindow(void) {}
